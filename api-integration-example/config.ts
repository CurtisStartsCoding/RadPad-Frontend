...
// API server URL - Use environment variable if available, otherwise empty string
// In a real project, this would be set by Vite from import.meta.env.VITE_API_SERVER_URL
