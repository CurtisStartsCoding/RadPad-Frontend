  ...
  return (
    <div className="p-6">
      <PageHeader 
        ...
        description="Invite and manage your organization's users"
      >
      ...
      <Card className="mb-6">
        <CardHeader className="pb-0">
          ...
          <p className="text-sm text-slate-500">Manage user accounts and invitations for your organization</p>
        </CardHeader>
        <CardContent>
