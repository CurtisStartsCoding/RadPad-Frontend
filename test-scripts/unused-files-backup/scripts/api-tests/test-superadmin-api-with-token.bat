@echo off
echo Testing Super Admin API endpoints with super_admin token...
...
REM Set variables
set ORG_ID=1
set AUTH_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjk5OSwib3JnSWQiOjEsInJvbGUiOiJzdXBlcl9hZG1pbiIsImVtYWlsIjoidGVzdC5zdXBlcmFkbWluQGV4YW1wbGUuY29tIiwiaWF0IjoxNzQ1MjA5NDcxLCJleHAiOjE3NDUyOTU4NzF9.LXASVRwKGzqReJDFDTEHitdONQRONjwx2q1wlf9SKx4
...
echo Using super_admin token for authentication
