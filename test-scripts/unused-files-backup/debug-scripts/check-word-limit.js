/**
 * Script to check the word_limit field in the prompt_templates table
 */
...
async function run() {
  ...
  try {
    ...
    // Update the word_limit field if it's null
    if (template.word_limit === null) {
      console.log('\nUpdating word_limit field...');
      await client.query(`
        ...
        WHERE id = $1;
      `, [template.id]);
      console.log('Word limit updated to 500');
