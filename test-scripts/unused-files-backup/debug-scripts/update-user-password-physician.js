// Script to update the test physician user's password hash
...
console.log('This tool will update the test physician user\'s password hash.');
...
async function run() {
  try {
    // Update the test physician user's password
    const testEmail = 'test.physician@example.com';
