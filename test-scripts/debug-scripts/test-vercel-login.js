// Script to test the Vercel deployment login endpoint
const fetch = require('node-fetch');

// Vercel deployment URL
const VERCEL_URL = 'https://radorderpad-jwtja60z4-capecomas-projects.vercel.app';
...
async function testLogin() {
  console.log('Testing login endpoint on Vercel deployment...');
...
async function testHealth() {
  console.log('Testing health endpoint on Vercel deployment...');
