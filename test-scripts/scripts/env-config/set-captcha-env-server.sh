...
echo "Adding RECAPTCHA_SECRET_KEY to production environment..."
...
# Set development mode (optional, only if you want to force development mode on production)
# echo "Adding NODE_ENV to production environment..."
# vercel env add NODE_ENV production
# echo "Enter this value when prompted: development"

# Set test mode flag (optional, only if you want to enable test mode on production)
echo "Adding TEST_MODE to production environment..."
