...
import { CheckCircle, ClipboardCheck, AlertTriangle, AlertCircle, FileText, Briefcase, Tag } from "lucide-react";
...
const ValidationView = ({ 
  ...
  // No extraction needed now that we're only showing the full dictation text
